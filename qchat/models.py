...
class RespuestaTutorQChat(models.Model):
    id_conjunto = models.ForeignKey(ClaveConjunto, on_delete=models.CASCADE)
    pregunta = models.ForeignKey(PreguntaQchat, on_delete=models.CASCADE)
...
class RespuestasQChat(models.Model):
    ...
    def valoracion(self):
        return "AR" if self.puntuacion > 51.8 else "MR" if self.puntuacion > 26.7 else "BR"
